...
+ Возможно, вам поможет [этот FAQ](https://github.com/vanessa-opensource/add/blob/develop/F.A.Q.MD)

Чтобы у вас работало создание автовидеоинструкций, необходимо установить дополнительный софт.

Инструкция по настройке окружения для формирования автовидеоинструкций [здесь](https://github.com/vanessa-opensource/add/blob/develop/doc/bdd/MakeAutoVideo.md).
